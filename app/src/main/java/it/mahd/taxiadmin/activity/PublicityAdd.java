...
public class PublicityAdd extends Fragment {
    ...
    private EditText Name_etxt, Price_etxt;
    private TextInputLayout Name_input, Price_input;
    ...
    private void addForm() {
        ...
        params.add(new BasicNameValuePair(conf.tag_places, Price_etxt.getText().toString()));
